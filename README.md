...
## Overview
A self project analyzing LAPD crime data (2020-2024, ~1M records) to practice SQL fundamentals. I used SQLite (DB Browser for SQLite) to query a public dataset. Currently I am a completing the Coursera Google Data Analytics Professional Certificate and other SQL courses, and will return to improve this upon completetion. 
...
Central logged more reported crimes than any other LAPD area from 2020 to 2024, ahead of 77th Street and Pacific. This can help law enforcement determine future resource planning.

**4. Data quality catch: 2024 excluded from year-over-year analysis**
Monthly record counts look complete and even across 2020 to 2023, but 2024 drops off sharply toward the end of the year (January had about 4x the records of December). This is areporting lag, not an actual drop in crime, so I left 2024 out of any trend comparisons to not inaccurately skew the data.

## Files
- `queries.sql` — all queries used in this project
